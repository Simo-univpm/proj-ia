...
/*
sto coso consiglia componenti sulla base della similarità tra oggetti nella cronologia e oggetti recensiti
quindi praticamente ti vuole far comprare una cosa che già hai e fa schifo ar cazzo
*/